...
@property (nonatomic, assign, readonly) BOOL supportsNormalTextureEditing;
...
-(BOOL)updateSelectionWithNormalTextureData:(NSData*)textureData mediaType:(NSString*)mediaType
    error:(NSError* _Nullable * _Nullable)error;
